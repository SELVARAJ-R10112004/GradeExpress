...
import StudentCourses from "./Components/Incharge/StudentCourses";  
   ...
   return (
    <div className="App">
     <Routes>
        ...
        <Route path='/verifyCertificate/:regno' element={<Verify user={user} setUser={setUser} logout={logout}/>}></Route>
        <Route path='/course-details' element={<DisplayCourse_info/>}></Route>
        <Route path="/add-students" element={<AddStudents user={user} />} />
